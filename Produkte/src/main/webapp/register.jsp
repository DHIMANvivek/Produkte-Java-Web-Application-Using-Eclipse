						...
						<form action="RegisterServlet" method="post"
							...
							<div class="form-group">
								<label for="phone">User Phone</label> <input type="number"
									...
									name="userphone" placeholder="Enter Phone" required>
							</div>

							<div class="form-group">
								<label for="phone">User Address</label>
								<textarea style="height: 90px" class="form-control"
									placeholder="Enter Address" name="useraddress" required></textarea>
							</div>

							<div class="form-group">
								<label>Select Product Pic</label><br> <input type="file"
									class="form-control" name="productPic" required>
							</div>
